const Footer = () => {
  return (
    <footer className="tracking-wide bg-slate-100 dark:bg-gray-900 px-8 sm:px-12 pt-12 pb-6">
      <div className="grid min-[1200px]:grid-cols-3 gap-12 xl:gap-16">
        ...
        <div className="min-[1200px]:max-w-sm max-w-lg w-full">
          ...
          <div className="mt-6">
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
              Your premium destination for artisanal beverages. From craft
              coffees to refreshing mocktails, we bring the finest drinks
        ...
        <div className="min-[1200px]:col-span-2 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="max-lg:min-w-[140px]">
            <h4 className="text-slate-900 dark:text-white font-semibold text-base relative">
              Shop
            </h4>
            <ul className="mt-6 space-y-4">
              <li>
                <a
                  href="javascript:void(0)"
                  className="hover:text-amber-600 dark:hover:text-amber-400 text-slate-600 dark:text-slate-400 text-sm font-normal transition-colors"
                >
                  All Drinks
                </a>
              </li>
      ...
      <div className="flex flex-wrap max-md:flex-col gap-4">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm md:ml-auto">
          © {new Date().getFullYear()} DrinkUp. All rights reserved.
          <span className="block sm:inline sm:ml-1">Sip responsibly.</span>
        </p>
      </div>
    </footer>
  );
