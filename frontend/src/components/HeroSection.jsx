        ...
        <div className="grid lg:grid-cols-2 items-center gap-x-12 gap-y-16">
          <div className="max-lg:text-center">
            <h1 className="md:text-5xl text-4xl !leading-tight font-bold text-slate-900 mb-6">
              Discover Premium Drinks Delivered to Your Doorstep
            </h1>
            <p className="text-base text-slate-600 leading-relaxed">
              From artisanal coffees to refreshing craft beverages, explore our
              curated collection of premium drinks. Fast delivery, exceptional
              quality, and flavors that will delight your taste buds.
            </p>
